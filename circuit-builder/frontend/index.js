...
"use strict";
    ...
    // gate images
    let image = document.getElementById("NOT-GATE");
    ...
    api.onCanvasUpdate(function (myCanvas) {
        ...
        for (let key in myCanvas.connector) {
    ...
    if (username) {
        ...
        document.querySelector('#my_canvas').classList.remove('hidden');
    } else {
