...
$(document).ready(function(){
    ...
    api.onCanvasListUpdate(function (items, signedInUser ) {
        ...
        items.forEach(function (item) {
            ...
            let elmt_del = document.createElement('div');
            elmt_del.className = "del";
            elmt_del.innerHTML = `<div class="del"><img id="del_icon" src="media/delete-icon.png" width="30" height="30"/></div>
            `;

            document.getElementById("canvas_list_display").prepend(elmt_del);

            /*
            // delete this canvas
            elmt_del.addEventListener('click', function(e)  {
            ...
            */
            ...
            elmt.addEventListener('click', function(e) {
                ...
                // document.getElementById("current_user_info").prepend(elmtUserInfo);
                //
    //            document.querySelectorAll(".gallery_owner_btn").style.backgroundColor = "white";
